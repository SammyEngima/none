main()
{
	...
	{
		setDvar( "class_assault_limit", 28 );
		setDvar( "class_specops_limit", 28 );
		setDvar( "class_demolitions_limit", 28 );
		setDvar( "class_sniper_limit", 28 );
	...
	// website
	setDvar( "promod_hud_website", "^5|EFR| Promodlive 2.16" ); // (avoid "//" here)
	...
	setDvar( "promod_mc_message_1", "^3Visit Us ^2www.extremeforcerangers.tk" );
	setDvar( "promod_mc_message_2", "^2WELCOME TO ^5|EFR|^2PROMODLIVE" );
